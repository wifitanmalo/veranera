...
# Function to the table of plates
def plate_table():
    tree = ttk.Treeview(plate)
    tree["columns"] = ("Name", "Value", "Description", "Available")
    tree.column("#0", width=0, stretch=tk.NO)
    tree.column('Name', width=60, anchor=tk.CENTER)
    tree.column('Value', width=60, anchor=tk.CENTER)
    tree.column('Description', width=80)
    tree.column('Available', width=80, anchor=tk.CENTER)
